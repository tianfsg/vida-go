...
type Language struct {
	...
	MenuArtText              string `json:"menuArtText"`
	MenuPortfolioText        string `json:"menuPortfolioText"`
	MenuContactText          string `json:"menuContactText"`
	...
	ComplementarySkill4Title string `json:"ComplementarySkill4Title"`
	ComplementarySkill41     string `json:"ComplementarySkill41"`
	ComplementarySkill42     string `json:"ComplementarySkill41"`
	ComplementarySkill43     string `json:"ComplementarySkill43"`
